...
let () =
    ...
    , [ (DataOnly, UArray UInt); (DataOnly, UArray UInt)
      ; ( AutoDiffable
        , UFun
            ...
            , FnPlain
            , Common.Helpers.AoS ) ); (AutoDiffable, UVector)
      ; (DataOnly, UArray UVector); (DataOnly, UArray UReal)
      ; (DataOnly, UArray UInt); (AutoDiffable, UVector) ]
    , AoS ) ;
  add_qualified
    (* same as above with tuning parameters. *)
    ( "laplace_marginal_bernoulli_logit_lpmf"
    , ReturnType UReal
    , [ (DataOnly, UArray UInt); (DataOnly, UArray UInt)
      ; ( AutoDiffable
        , UFun
            ...
            , Common.Helpers.AoS ) ); (AutoDiffable, UVector)
      ; (DataOnly, UArray UVector); (DataOnly, UArray UReal)
      ; (DataOnly, UArray UInt); (AutoDiffable, UVector); (DataOnly, UReal)
      ; (DataOnly, UInt) ]
    , AoS ) ;
  add_qualified
    (* function signature with x as a matrix. *)
    ( "laplace_marginal_bernoulli_logit_lpmf"
    , ReturnType UReal
    , [ (DataOnly, UArray UInt); (DataOnly, UArray UInt)
      ; ( AutoDiffable
        , UFun
            ...
            , FnPlain
            , Common.Helpers.AoS ) ); (AutoDiffable, UVector)
      ; (DataOnly, UMatrix); (DataOnly, UArray UReal); (DataOnly, UArray UInt)
      ; (AutoDiffable, UVector) ]
    , AoS ) ;
  add_qualified
    (* same as above with tuning parameters for Newton solver *)
    ( "laplace_marginal_bernoulli_logit_lpmf"
    , ReturnType UReal
    , [ (DataOnly, UArray UInt); (DataOnly, UArray UInt)
      ; ( AutoDiffable
    ...
    , AoS ) ;
  add_qualified
    (* rng function with x as an array of vectors *)
    ...
    , AoS ) ;
  add_qualified
    (* rng function with x as a matrix *)
    ( "laplace_bernoulli_logit_rng"
    , ReturnType UVector
    , [ (DataOnly, UArray UInt); (DataOnly, UArray UInt)
      ; ( AutoDiffable
  ...
  add_qualified
    ...
    ( "laplace_marginal_poisson_log_lpmf"
    , ReturnType UReal
    , [ (DataOnly, UArray UInt); (DataOnly, UArray UInt); (DataOnly, UVector)
      ; ( AutoDiffable
        , UFun
            ( [ (AutoDiffable, UVector); (DataOnly, UArray UVector)
              ; (DataOnly, UArray UReal); (DataOnly, UArray UInt) ]
    ...
    , AoS ) ;
  add_qualified
    (* function signature with x as array of vectors. *)
  ...
  add_qualified
    ...
    , AoS ) ;
  add_qualified
    (* general implementation without tuning parameters *)
    ...
    , AoS ) ;
  add_qualified
    (* general implementation with tuning parameters *)
    ( "laplace_marginal_lpdf"
    , ReturnType UReal
    , [ (DataOnly, UVector)
      ; ( AutoDiffable
